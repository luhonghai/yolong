              ...
              <section class="scrollable">
                ...
                <ul class="list-group no-bg no-borders auto">
                  <li class="list-group-item">
                    <div class="media"> <span class="pull-left thumb-sm avatar"> <img src="images/a3.jpg" alt="John said" class="img-circle"> <i class="on b-black bottom"></i> </span>
                  ...
                  <li class="list-group-item">
                    <div class="media"> <span class="pull-left thumb-sm avatar"> <img src="images/a2.jpg" alt="John said"> <i class="on b-black bottom"></i> </span>
                      <div class="media-body">
                  ...
                  <li class="list-group-item">
                    <div class="media"> <span class="pull-left thumb-sm avatar"> <img src="images/a1.jpg" alt="John said"> <i class="busy b-black bottom"></i> </span>
                      <div class="media-body">
                  ...
                  <li class="list-group-item">
                    <div class="media"> <span class="pull-left thumb-sm avatar"> <img src="images/a0.jpg" alt="John said"> <i class="away b-black bottom"></i> </span>
                      <div class="media-body">
...
<?php } ?>
<script src="../plugins/redactor/redactor.js?ver=1.0.0" /></script> 
