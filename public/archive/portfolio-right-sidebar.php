...
<?php $title = 'Right Sidebar Portfolio - Multipurpose Responsive HTML5 Themes with Animated Metro Slider'; ?>
<?php $keywords = 'HTML5 Template, CSS3, Metro Slider, Elegant HTML5 Theme'; ?>
<?php $description = 'Right Sidebar Portfolio Page Multipurpose Responsive HTML5 Themes with Animated Metro Slider '; ?>
...
<!-- Middle Content Start -->
  <div class="vc_banner-title <?php if (isset($banner_title_bg)) echo $banner_title_bg; ?> block">
    <div class="wrapper">
      <div class="container">
        <h1>Right <span class="vc_main-color">Sidebar</span></h1>
        <ul class="breadcrumb">
