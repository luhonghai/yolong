...
<?php $title = 'Full Width Single Project Portfolio - Multipurpose Responsive HTML5 Themes with Animated Metro Slider'; ?>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-12 project-details">
            <h2 style="margin-top:10px; margin-bottom:0;">Great Project Name</h2>
            <div class="vc_share-post">
              ...
              <div class="widget"> 
                ...
                <a class="addthis_button" href="http://www.addthis.com/bookmark.php?v=300&amp;pubid=ra-51f5ff9515d6d31e"><img alt="Bookmark and Share" src="http://s7.addthis.com/static/btn/v2/lg-share-en.gif" width="125" height="16" style="border:0"/></a>
