...
<?php $title = '2 Columns Portfolio - Multipurpose Responsive HTML5 Themes with Animated Metro Slider'; ?>
  ...
  <div class="vc_portfolio block">
    <div class="wrapper">
      <div class="container">
        ...
        <div id="portfolio" class="vc_portfolio-page portfolio-2 row clearfix">
          <div class="col-sm-6 col-md-6 portfolio-item p-icons">
          ...
          <div class="col-sm-6 col-md-6 portfolio-item p-web">
          ...
          <div class="portfolio-item p-illustration p-logo col-md-6">
          ...
          <div class="portfolio-item p-icons p-logo col-md-6">
            <div class="vc_anim vc_anim-slide"> <a href="portfolio-single-project.php" class="vc_preview"> <img alt="example image" src="img/portfolio/02.jpg" /> </a>
              <div class="vc_hover">
                <div class="hover-wrapper">
                  <div class="text-wrapper">
                  ...
                  <div class="icon-wrapper">
                    <ul>
                      <li class="vc_icon"> <a  data-rel="prettyPhoto[portfolio-1]" href="img/portfolio/02.jpg" > <i class="fa fa-search-plus"> </i> </a> <a data-rel="prettyPhoto[portfolio-1]" class="hidden" href="img/portfolio/01.jpg" ></a> <a data-rel="prettyPhoto[portfolio-1]" class="hidden" href="img/portfolio/03.jpg" ></a> </li>
                      <li class="vc_icon"> <a  href="portfolio-single-project.php" > <i class="fa fa-link"> </i> </a> </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="portfolio-item p-web p-logo col-md-6">
            <div class="vc_anim vc_anim-slide"> <a href="portfolio-single-project.php" class="vc_preview"> <img alt="example image" src="img/portfolio/03.jpg" /> </a>
              <div class="vc_hover">
                <div class="hover-wrapper">
                  <div class="text-wrapper">
          ...
          <div class="portfolio-item p-illustration col-md-6">
            <div class="vc_anim vc_anim-slide"> <a  href="portfolio-single-project.php" class="vc_preview"> <img alt="example image" src="img/portfolio/01.jpg" /> </a>
              <div class="vc_hover">
                <div class="hover-wrapper">
                  <div class="text-wrapper">
            ...
            <div class="vc_anim vc_anim-slide"> <a href="portfolio-single-project.php" class="vc_preview"> <img alt="example image" src="img/portfolio/02.jpg" /> </a>
              <div class="vc_hover">
                <div class="hover-wrapper">
                  ...
                  <div class="icon-wrapper">
                    <ul>
                      <li class="vc_icon"> <a data-rel="prettyPhoto[p3]" class="hidden" href="img/portfolio/02.jpg" > <i class="fa fa-search-plus"> </i> </a> <a data-rel="prettyPhoto[p3]" class="hidden" href="img/portfolio/01.jpg" ></a> <a data-rel="prettyPhoto[p3]" class="hidden" href="img/portfolio/03.jpg" ></a> </li>
                      <li class="vc_icon"> <a  href="portfolio-single-project.php" > <i class="fa fa-link"> </i> </a> </li>
                    </ul>
                  </div>
                </div>
          ...
          <div class="portfolio-item p-web col-md-6">
            <div class="vc_anim vc_anim-slide"> <a href="portfolio-single-project.php" class="vc_preview"> <img alt="example image" src="img/portfolio/03.jpg" /> </a>
              <div class="vc_hover">
                <div class="hover-wrapper">
                  <div class="text-wrapper">
