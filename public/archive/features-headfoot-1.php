...
<?php $title = 'Header and Footer Style 1 - Multipurpose Responsive HTML5 Themes with Animated Metro Slider'; ?>
...
<?php $header = 'header-1';   // Header Type ?>
<?php $footer = 'footer-1';   // Footer Type ?>
<!-- End Demo -->
...
<!-- Middle Content Start -->
  <div class="vc_banner-title <?php if (isset($banner_title_bg)) echo $banner_title_bg; ?> block">
    <div class="wrapper">
      <div class="container">
        <h1>Header and Footer Style 1</h1>
        <ul class="breadcrumb">
          <li><a href="index.php">Home</a> </li>
          <li><a href="features-typography.php">Features</a> </li>
          <li class="active">Header 1 &amp; Footer 1</li>
        </ul>
      </div>
    </div>
    <!-- wrapper --> 
