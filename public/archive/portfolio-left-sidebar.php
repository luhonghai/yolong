...
<?php $title = 'Left Sidebar Portfolio - Multipurpose Responsive HTML5 Themes with Animated Metro Slider'; ?>
...
<!-- Middle Content Start -->
  <div class="vc_banner-title <?php if (isset($banner_title_bg)) echo $banner_title_bg; ?> block">
    <div class="wrapper">
      <div class="container">
        <h1>Left <span class="vc_main-color">Sidebar</span></h1>
        <ul class="breadcrumb">
      ...
      <div class="container">
        <div class="row">
          <div class="col-md-3 sidebar">
			<?php include('templates/sidebars/sidebar-large.tpl.php'); ?>
          </div>
          <!-- .col-md-3 -->
          <div class="col-md-9">
            ...
            <div id="portfolio" class="vc_portfolio-page portfolio-3 row clearfix">
              <div class="portfolio-item p-icons col-md-6">
