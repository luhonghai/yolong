...
<?php $title = 'Mini List Blog - Multipurpose Responsive HTML5 Themes with Animated Metro Slider'; ?>
...
<!-- Middle Content Start -->
  <div class="vc_banner-title <?php if (isset($banner_title_bg)) echo $banner_title_bg; ?> block">
    <div class="wrapper">
      <div class="container">
        <h1>Mini Image <span class="vc_main-color">Blog</span></h1>
        <ul class="breadcrumb">
          <li><a href="index.php">Home</a> </li>
          <li><a href="blog-list-mini.php">Blogs</a> </li>
          <li class="active">Mini Image</li>
        </ul>
      </div>
    </div>
    <!-- wrapper --> 
