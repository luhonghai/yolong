<!-- Footer Start -->
  <footer class="footer-2  <?php if (isset($footer_mode)) echo $footer_mode; ?>"  id="footer">
      ...
      <div class="wrapper">
        <div class="container">
          ...
          <div class="row">
            ...
            <div id="vc_footer-newsletter" class="footer-widget widget col-md-3">
				<?php include('templates/widgets/widget-newsletter.tpl.php'); ?>
            </div>
            <div id="vc_footer-about-mini" class="footer-widget widget col-md-3">
				<?php include('templates/widgets/widget-about-mini.tpl.php'); ?>
            </div>
            <div id="vc_footer-social-rounded" class="footer-widget widget col-md-3">
