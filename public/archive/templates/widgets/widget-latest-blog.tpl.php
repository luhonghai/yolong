<div class="vc_blog-list">
  ...
  <article class="blog-row clearfix">
    <div class="blog-left">
      <div class="vc_anim vc_anim-slide"> <a href="portfolio-single-project.php" class="vc_preview"> <img alt="example image" src="img/blog/01.jpg"  /> </a>
        <div class="vc_hover">
  ...
  <article class="blog-row clearfix">
    <div class="blog-left">
      <div class="vc_anim vc_anim-slide"> <a href="blog-single.php" class="vc_preview"> <img alt="example image" src="img/blog/02.jpg"  /> </a>
        <div class="vc_hover">
          <div class="hover-wrapper">
            <div class="icon-wrapper">
              <ul>
    ...
    <div class="blog-right clearfix">
      ...
      <span class="date"> 14 February 2013 </span> <span class="comments"> <i class="fa fa-comments"> </i> 16 </span> <span class="taxonomy"> <i class="fa fa-tags"> </i> <a href="#"> Design </a>, <a href="#"> Creative </a> </span>
      <div class="description">
        <p> Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incidtation ullamco... <a href="blog-single.php" class="vc_read-more"> read more </a> </p>
      </div>
    </div>
  </article>
  <article class="blog-row">
    <div class="blog-left">
      <div class="vc_anim vc_anim-slide"> <a href="blog-single.php" class="vc_preview"> <img alt="example image" src="img/blog/03.jpg"  /> </a>
        <div class="vc_hover">
          <div class="hover-wrapper">
            <div class="icon-wrapper">
              <ul>
