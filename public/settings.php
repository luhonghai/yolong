...
<section class="panel panel-default">
	...
	<div class="panel-body">
			...
			<div class="form-group">
                <div class="col-md-12">
					<label class="col-sm-3 control-label">Points System</label>
                    <div class="col-sm-7">
						<label class="switch">
							<input type="checkbox" id="points_system" name="points_system" value="1" <?php echo (1 == get_option('points_system')) ? 'checked' : ''; ?>>
                        <span></span> </label>
                    </div>
					<button type="button" data-option="points_system" class="col-md-2 btn btn-primary update-check">Update</button>
                </div>
            </div>
