...
$config = array(
	...
	'types' => array(
		...
		'avatar' => array(
	    	'crop_width'  => 180,  // Crop image to this width
	    	'crop_height' => 180,  // Crop image to this height
		...
		'challenges' => array(
	    	'crop_width'  => 1280,  // Crop image to this width
	    	'crop_height' => 720,  // Crop image to this height
	    	'force_crop'  => true, // If the image width, height is less than crop_width, crop_weight force the crop
	    	'min_width'   => 640,  // Minimum width required 
	    	'min_height'  => 480,  // Minimum height required
	    	//'max_width'   => null, // Maximum width allowed (null - not set)
	    	//'max_height'  => null, // Maximum height allowed (null - not set)
		...
		'dares' => array(
	    	'crop_width'  => 128,  // Crop image to this width
	    	'crop_height' => 72,  // Crop image to this height
	    	'force_crop'  => true, // If the image width, height is less than crop_width, crop_weight force the crop
	    	'min_width'   => 64,  // Minimum width required 
	    	'min_height'  => 48,  // Minimum height required
	    	//'max_width'   => null, // Maximum width allowed (null - not set)
	    	//'max_height'  => null, // Maximum height allowed (null - not set)
	...
	'max_file_size' => 100000, // in KB (1000KB = 1MB)
